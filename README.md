...
The script is used to install the FreeRADIUS Server on ~~CentOS 6.x.~~ Debian. To install FreeRADIUS, you just need to keep all the files into one directory and execute 'master.sh' file.
